import HeroBanner from "@/components/capitalReverse/capitalReverseTransparency/HeroBanner";
import USFFCapitalReserveStructure from "@/components/capitalReverse/capitalReverseTransparency/USFFCapitalReserveStructure";
import USFFPolicyAndUsageSection from "@/components/capitalReverse/capitalReverseTransparency/USFFPolicyAndUsageSection";
...
const capitalReserveTransparency = () => {
  return (
    <>
      ...
      <HeroBanner />
      <Container>
        <USFFCapitalReserveStructure />
        <USFFPolicyAndUsageSection />
      </Container>
    </>
  );
};
