...
import HeroBanner from "@/components/capitalReverse/FlowChart/HeroBanner";
import USFFFirstSalesStructure from "@/components/capitalReverse/FlowChart/USFFFirstSalesStructure";
import USFFFoundersAndCapitalUseSection from "@/components/capitalReverse/FlowChart/USFFFoundersAndCapitalUseSection";
...
export default function FlowChartContent() {
  return (
    <div>
      ...
      <HeroBanner />
      <Container>
        <USFFFirstSalesStructure />
        <USFFFoundersAndCapitalUseSection />
      </Container>
    </div>
  );
}
