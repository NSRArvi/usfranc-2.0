      ...
      <div className="pb-12 mt-10 ">
        ...
        <div className="flex gap-10 items-start">
          <article className="flex-1 min-w-0">
            <span className="inline-block text-[11px] font-semibold tracking-wider px-2.5 py-0.75 rounded-full bg-[#dbeafe] text-primary">
              {blog?.category_name}
            </span>
            ...
            <div className="flex items-center flex-wrap gap-3.5 mt-4">
              <div className="flex items-center gap-2.5">
                <div className="w-9 height-9 rounded-full bg-[#dbeafe] text-primary text-[12px] font-semibold flex items-center justify-center shrink-0">
                  BF
                </div>
                <div>
            ...
            <div className="border border-[#e5e7eb] rounded-xl p-5 mt-6">
              ...
              <div className="flex gap-3.5 items-start">
                <div className="w-11 h-11 text-[14px] rounded-full bg-[#dbeafe] text-primary font-semibold flex items-center justify-center shrink-0">
                  BF
                </div>
                <div>
                  <p className="text-[13px] font-semibold text-[#111827] m-0">
